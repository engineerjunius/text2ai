    ...
    className='text-center min-h-[80vh pt-14 mb-10'>
      ...
      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item, index)=>(
          ...
          <button className='w-full bg-gray-700 text-white mt-8 text-sm rounded-md py-2.5 min-w-52 cursor-pointer hover:border-amber-300 hover:border-2'>{user ? 'Purchase' : 'Get Started'}</button>
